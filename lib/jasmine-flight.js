  ...
  var describeMixinFactory = function (mixinPath, specDefinitions) {
    return function () {
      beforeEach(function (done) {
        ...
        var requireCallback = function (registry, defineComponent, withNameSpace, Mixin) {
          registry.reset();
          this.Component = defineComponent(function () {}, withNameSpace, Mixin);
          done();
        }.bind(this);

        require(['flight/lib/registry', 'flight/lib/component', 'bower_components/dev_utils/lib/withNameSpace', mixinPath], requireCallback);
      });
